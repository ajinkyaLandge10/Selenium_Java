...
//Create a Method for selecting user in WebTable --> This method is application Specific ( only works for ClassicCRMPro)
public class ClassiCRMWebTable {
	...
	public static String getUserCompanyName(String userName) {
		return driver.findElement(By.xpath("//a[text()='Robby Sing']/parent::td//following-sibling::td/a[@context='company']")).getText();
	}
